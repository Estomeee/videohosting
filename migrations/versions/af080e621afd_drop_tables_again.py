...
Revision ID: af080e621afd
Revises: a1fd36823d02
Create Date: 2023-06-07 12:57:22.773149
...
revision = 'af080e621afd'
down_revision = 'a1fd36823d02'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    sa.Column('id_auther', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('published_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['id_auther'], ['user.id'], name='comment_id_auther_fkey'),
    sa.ForeignKeyConstraint(['id_video'], ['video.id'], name='comment_id_video_fkey'),
    ...
    sa.Column('published_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['id_user'], ['user.id'], name='view_id_user_fkey'),
    sa.ForeignKeyConstraint(['id_video'], ['video.id'], name='view_id_video_fkey'),
